...
class Question():
    def __init__(self, question, right_answer, wrong1, wrong2):
...
questions_list = [] 
questions_list.append(Question('What is the biggest country in the world?', 'Russia', 'America', 'Canada'))
questions_list.append(Question('When did World War 2 end?', '1945', '1940', '1950'))
questions_list.append(Question('Which color is not in the Uganda flag?', 'Green', 'Black', 'Yellow'))
questions_list.append(Question('How many states does the USA has?', '50', '34', '45'))
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        print('Statistic\n-Total questions: ', window.title, '\n-Right answers:', window.score)
        print('Rating: ', (window.score/window.title*100), '%')
    else:
